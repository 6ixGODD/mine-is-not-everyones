...
| 07 | Four-agent installer, managed state, and doctor | READY | 06 |
...
| 10 | Concurrent release test tolerance | IN_PROGRESS | 06 |

## Topology

```text
01 -> 02 -> 02-1 -> 03 -> 04 -> 05 -> 05-1 -> 09 -> 09-1 -> 06 -> 07 -> 10 -> 08
```
